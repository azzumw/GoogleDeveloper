...
import com.example.forageapp.databinding.ListItemForgeableBinding
...
class ForageableListAdapter(private val clickListener: (Forageable)-> Unit) : ListAdapter<Forageable, ForageableListAdapter.ForageableViewHolder> (DiffCallback){
    ...
    class ForageableViewHolder(val binding:ListItemForgeableBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ForageableViewHolder {
        ...
        return ForageableViewHolder(
            ListItemForgeableBinding.inflate(layoutInflater, parent, false)
        )
    }
